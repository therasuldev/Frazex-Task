...
class _$_NewsModel implements _NewsModel {
  _$_NewsModel({required this.name, required this.image});
  ...
  @override
  String toString() {
    return 'NewsModel(name: $name, image: $image)';
  }
...
abstract class _NewsModel implements NewsModel {
  factory _NewsModel(
      {required final String name, required final String image}) = _$_NewsModel;
