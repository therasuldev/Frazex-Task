...
class Economy extends NewsStatefulWidget {
  Economy({Key? key}) : super(key: key);

  @override
  State<Economy> createState() => _EconomyState();
}

class _EconomyState extends NewsState<Economy> {
  @override
  void initState() {
    BlocProvider.of<AppBloc>(context).add(GetPageEvent(category: '3'));
    super.initState();
  }
